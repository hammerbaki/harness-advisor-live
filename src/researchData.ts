...
export const paperPositioning = [
  ...
  "Local and hosted runs share the same validation-oriented artifact structure.",
      ...
      detail:
        group.status === "source-ready"
          ...
          : group.sourceStatus === "poc-extracted"
            ? "Imported legacy wording; independent source verification is required before release."
